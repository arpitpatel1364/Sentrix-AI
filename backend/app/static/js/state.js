...
const PAGE_META = {
  ...
  'person-trail':    ['PERSON TRAIL', '// CROSS-CAMERA RE-ID MOVEMENT FORENSICS'],
  'crowd-density':   ['CROWD DENSITY MONITOR', '// LIVE HEADCOUNT TELEMETRY'],
  'notifications':   ['NOTIFICATION CENTER', '// ALERT DISPATCH CONFIG & HISTORY'],
  'travel-map':      ['TRAVEL MAP', '// VISUALIZING SUBJECT MOVEMENT ACROSS BLIND SPOTS'],
};
